...
export const deleteJptLab = (id: string) => axios.delete(`/jpt/${id}`)
export const getLabUniq = (name: string) =>
  axios(`/labs/${name}/uniq`).then((res) => res.data)
export const runJptLab = (id: string) => axios.get(`/jpt/${id}/run`)
export const stopJptLab = (id: string) => axios.get(`/jpt/${id}/stop`)
